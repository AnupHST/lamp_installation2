...
while true; do
        ...
        echo -en "$BWhite Do you want to allow Http/Https In Firewall .....Yes/No : $BYellow"
        read firewall
        case $firewall in
        [yY][eE][sS]|[yY]) break;;
        [nN][oO]|[nN])  break;;
...
while true; do
        ...
        echo -en "$BWhite Do you want to Install APEREO CAS .....Yes/No : $BYellow"
        read cas
        case $cas in
        [yY][eE][sS]|[yY]) 
                            while true; do
        
                                    echo -en "$BWhite Do you want to Install SSl with CAS .....Yes/No : $BYellow"
                                    read ssl
                                    case $ssl in
                                    [yY][eE][sS]|[yY]) 
...
yum update -y 
yum install wget vim zip unzip git -y
